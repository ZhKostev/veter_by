...
describe "wind_generators/new" do
  before(:each) do
    assign(:wind_generator, stub_model(WindGenerator,
      :title => "MyString",
      :min_rated_power => 1.5,
      :max_rated_power => 1.5,
  ...
  it "renders new wind_generator form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => wind_generators_path, :method => "post" do
